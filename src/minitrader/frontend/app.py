"""
minitrader/frontend/app.py — FastAPI 前端
运行: uv run python src/minitrader/frontend/app.py
...
from minitrader.frontend.preview import plain_digest_preview

app = FastAPI(title="MiniTrader")
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "minitrader"}
...
def main():
    from minitrader.service import server_host, server_port, start_server
