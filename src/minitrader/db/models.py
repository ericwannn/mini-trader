...
DB_DIR = os.path.dirname(os.path.abspath(__file__))  # src/minitrader/db/
PROJECT_DIR = os.path.abspath(os.path.join(DB_DIR, "..", "..", ".."))  # project root
_DB_PRIMARY = os.path.join(PROJECT_DIR, "minitrader.db")
_DB_LEGACY = os.path.join(PROJECT_DIR, "macro.db")
# 升级前若仅有 macro.db，继续沿用，避免丢数据
DB_PATH = _DB_PRIMARY if os.path.exists(_DB_PRIMARY) or not os.path.exists(_DB_LEGACY) else _DB_LEGACY
